...
if __name__ == "__main__":
    ...
    for current_seed in seeds:
        print(f"\n{'='*50}\nLANCEMENT ABC SEUL - SEED: {current_seed}\n{'='*50}")
        ...
        opt_abc = ABCOptimizer(layers=initial_arch, dataset=dummy_loader, pop_size=20, limit=5, patience=5)
        ...
        total_search_time = time.time() - start_time_abc
        evals_abc = opt_abc.eval_count
        print(f"Bilan recherche : {evals_abc} évaluations proxy réalisées.")
        ...
        with open(f"results/academic_results_ABC_30_{current_seed}.json", "w") as f:
            json.dump({"accuracy": final_accuracy, "evals": evals_abc, "time": total_search_time, "n_parameters": n_params}, f)
